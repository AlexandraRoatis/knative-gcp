...
func (l *Listers) GetHPALister() hpav1listers.HorizontalPodAutoscalerLister {
	return hpav1listers.NewHorizontalPodAutoscalerLister(l.indexerFor(&hpav1.HorizontalPodAutoscaler{}))
}
